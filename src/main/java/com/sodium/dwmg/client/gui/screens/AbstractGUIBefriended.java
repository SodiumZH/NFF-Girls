...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractGUIBefriended <T extends AbstractInventoryMenuBefriended> extends AbstractContainerScreen<T> {

	public IBefriendedMob mob;
	protected float xMouse = 0;
	protected float yMouse = 0;
	
	public AbstractGUIBefriended(T pMenu, Inventory pPlayerInventory, Component pTitle, IBefriendedMob mob) {

...
import com.sodium.dwmg.entities.ai.goals.BefriendedSunAvoidingFollowOwnerGoal;
...
/**
 * @author SodiumZH
 * This example shows how to make a friendly (tamed) Zombie with BefriendMobsAPI.
 ...
 */
public class Example_BefriendedZombie extends Zombie implements IBefriendedMob {
	 ...
	 * These overwritten AI goals are all added "Befriended" prefix.
	 ...
	 * the input of getBauble() is the "Bauble index", i.e. if there are 2 bauble slots the indexes should be 0 or 1.
	...
	public AbstractInventoryMenuBefriended makeMenu(int containerId, Inventory playerInventory, Container container) {
		return new Example_InventoryMenuVanillaUndeadTwoBaubles(containerId, playerInventory, container, this);
	}

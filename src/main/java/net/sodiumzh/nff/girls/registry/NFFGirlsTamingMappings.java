...
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagAlrauneTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagBansheeTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagCreeperGirlTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagCrimsonSlaughtererTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagCursedDollTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagEnderExecutorTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagGhastlySeekerTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagHarpyTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagHornetTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagHuskGirlTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagImpTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagJackFrostTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagJiangshiTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagKoboldTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagMeltyMonsterTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagNecroticReaperTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagNightwalkerTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagRedcapTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagSkeletonGirlTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagSlimeGirlTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagSnowCanineTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagWitherSkeletonGirlTamingProcess;
import net.sodiumzh.nff.girls.entity.handlers.hmag.HmagZombieGirlTamingProcess;

...
public class NFFGirlsSkeletonRangedBowAttackGoal extends NFFRangedBowAttackGoal {

	public NFFGirlsSkeletonRangedBowAttackGoal(INFFTamed pMob, double pSpeedModifier, int pAttackIntervalMin,
			float pAttackRadius) {

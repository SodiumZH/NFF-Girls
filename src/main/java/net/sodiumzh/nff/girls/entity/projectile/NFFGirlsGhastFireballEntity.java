...
public class NFFGirlsGhastFireballEntity extends Fireball
{
	...
	public NFFGirlsGhastFireballEntity(EntityType<? extends NFFGirlsGhastFireballEntity> pEntityType,
			Level pLevel)
	{
		super(pEntityType, pLevel);
	}

	public NFFGirlsGhastFireballEntity(Level pLevel, LivingEntity pShooter, double pOffsetX, double pOffsetY,

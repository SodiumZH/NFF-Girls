...
public class NFFGirlsHmagDodomekiInventoryMenu extends NFFGirlsInventoryMenuPreset0
{

	public NFFGirlsHmagDodomekiInventoryMenu(int containerId, Inventory playerInventory, Container container, INFFTamed mob)
	{

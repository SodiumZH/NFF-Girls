...
public class NFFGirlsNecroticReaperInventoryMenu extends NFFGirlsHandItemsFourBaublesInventoryMenu
{

	public NFFGirlsNecroticReaperInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob)
	{

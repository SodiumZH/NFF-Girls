...
public class HmagMeltyMonsterInventoryMenu extends NFFGirlsInventoryMenuPreset0
{

	public HmagMeltyMonsterInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob)
	{

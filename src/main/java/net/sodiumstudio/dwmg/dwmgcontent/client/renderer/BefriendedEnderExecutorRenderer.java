package net.sodiumstudio.dwmg.dwmgcontent.client.renderer;
...
import net.sodiumstudio.dwmg.dwmgcontent.client.renderer.layers.BefriendedEnderExecutorCarriedBlockLayer;
import net.sodiumstudio.dwmg.dwmgcontent.client.renderer.layers.BefriendedEnderExecutorEyesLayer;
...
public class BefriendedEnderExecutorRenderer extends MobRenderer<EntityBefriendedEnderExecutor, BefriendedEnderExecutorModel<EntityBefriendedEnderExecutor>>
{
	...
	public BefriendedEnderExecutorRenderer(EntityRendererProvider.Context context)
	{

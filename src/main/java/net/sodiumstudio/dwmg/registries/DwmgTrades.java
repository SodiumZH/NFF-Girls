...
public class DwmgTrades
{
	...
	static
	{
		...
		.push(COMMON_UNDEAD)
		.setRequiredLevel(1)
		.addBuys(ModItems.SOUL_POWDER.get(), 16, 21, 1, 1, 4)
		...
		.setRequiredLevel(3)
		.addBuys(ModItems.SOUL_APPLE.get(), 1, 1, 1, 1, 4)
		...
		.addBuys(Items.ZOMBIE_HEAD, 1, 1, 6, 8, 2)
		...
		.addBuys(Items.TOTEM_OF_UNDYING, 1, 1, 8, 13, 1)
		...
		.setRequiredLevel(5)
		.addSells(16, 20, Items.TRIDENT, 16, 21, 1)
		.addSells(1, 1, Items.HEART_OF_THE_SEA, 24, 33, 1)

...
要与之互动，玩家必须佩戴死灵巫师的帽子，或在主副手之一持有死灵巫师之杖，否则将无法切换AI或打开GUI，并且它不会攻击玩家的目标。
...
如果玩家佩戴死灵巫师的帽子，拥有的死灵收割者在周围（8格以内）会付与玩家再生效果，等级取决于周围的总数量（最高等级III）。
...
攻击目标不会将死灵巫师之杖的效果视为玩家的攻击，因此该武器的攻击不会引起对象的仇恨。
